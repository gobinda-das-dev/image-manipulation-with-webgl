...
function appendNav() {
   ...
   canvasContainer.innerHTML += `
      <nav class="h-screen font-medium w-[32vw] bg-[#f5f5f5] py-[10vh] flex flex-col gap-10 text-[#333] fixed right-0 top-0 px-[5vw] overflow-y-auto">
        ...
        <a data-cursor-scale="2" href="https://github.com/gobinda-das-dev/image-manipulation-with-webgl/tree/main${currentPath}" target="_blank" class="underline">Source code</a>
